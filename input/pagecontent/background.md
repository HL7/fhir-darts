...
This IG defines the specifications by which organizations can de-identify and/or anonymize information which can then be used as part of data exchanges and workflows. 
...
* Reduce EHR burden in generating the de-identified and anonymized data by providing a consistent representation of the data 
* Align with existing standards and regulations such as ONC 2015 Edition, 2015 Edition Health IT Certification Criteria, 2015 Edition Cures Update and Health Data, Technology, and Interoperability (HTI-1) Final Rule while improving the timeliness and completeness of data for the specified [Use Cases](usecases.html). 
...
* Policies and processes followed by data submitters that allow data sharing, collecting consent, or compliance with regulatory requirements.
