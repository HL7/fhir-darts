...
This guide is based on the [HL7 FHIR R4]({{site.data.fhir.path}}index.html) standard, and is aligned with [US Core IG]({{site.data.fhir.uscoreR4}}/index.html) terminology, [Data Exchange for Quality Measures - DEQM]({{site.data.fhir.deqm}}/index.html) and [QI Core]({{site.data.fhir.qicore}}/index.html) IG.
